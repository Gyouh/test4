...
document.addEventListener('DOMContentLoaded', () =>{
    ...
    bottomPageBtn.addEventListener('click', () => 
    {
        ...
        pageEnd.scrollTo(0, 1500);

        // document.querySelector('.footer__end > div:last-child > ul li').style.animationName = "contactAnimation";
        // document.querySelector('.footer__end > div:last-child > ul li').removeProperty(animationName);

        if(document.querySelector('.footer__end > div:last-child > ul li').animationName === "contactAnimation")
            document.querySelector('.footer__end > div:last-child > ul li').style.animationName = "";
        else
            document.querySelector('.footer__end > div:last-child > ul li').style.animationName = "contactAnimation";
    }); 
